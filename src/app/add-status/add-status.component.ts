...
public statusForm:any;
  constructor(public dialogbox:MatDialogRef<AddStatusComponent>,@Inject(MAT_DIALOG_DATA) public data: any,private route:ActivatedRoute,private bookingService:BookingService) {
